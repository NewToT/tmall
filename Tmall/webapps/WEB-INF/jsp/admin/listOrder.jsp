...
<script>
    $(function(){
        $("button.orderPageCheckOrderItems").click(function(){
            ...
            $("tr.orderPageOrderItemTR[oid="+oid+"]").toggle();/* 控制点击后显示隐藏订单项详情，加入oid传入到下面通过订单id查询具体的订单项 */
        });
    });
        ...
        <table class="table table-striped table-bordered table-hover1  table-condensed">
            ...
            <c:forEach items="${os}" var="o">
                <tr>
                    <td>${o.id}</td>
                    <td>${o.statusDesc}</td>
                    <td>￥<fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2"/></td><!--formatNumber，把字符转为数字  -->
                    ...
                    <td><fmt:formatDate value="${o.confirmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td><!-- formatDate 使用不同的方式格式化日期。 -->
